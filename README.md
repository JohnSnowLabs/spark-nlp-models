...
| `NerDLModel`               | `ner_events_clinical`                           | `2.5.0` | [:mag:](# 'Extracts: Problem, Test, Treatment, Occurence, Clinical_Dept, Date, Evidential, Duration, Frequency, Time ')                                                                                                                         | [:clipboard:](https://portal.dbmi.hms.harvard.edu/projects/n2c2-nlp/ 'Trained on i2b2 events data with `clinical_embeddings`')                                                                              | [:floppy_disk:](https://s3.console.aws.amazon.com/s3/object/auxdata.johnsnowlabs.com/clinical/models/ner_events_clinical_en_2.5.0_2.4_1590021303624.zip 'Download')                           |
...
| `RelationExtractionModel`  | `re_temporal_events_clinical`                                   | `2.5.5` | [:mag:](# 'Extracts: Temporal relations (AFTER, BEFORE and OVERLAP) between clinical events (`ner_events_clinical`)')                                                                    | [:clipboard:](https://portal.dbmi.hms.harvard.edu/projects/n2c2-nlp/ 'Trained on 2012 i2b2 competition data with `clinical_embeddings`')                                                                           | [:floppy_disk:](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/clinical/models/re_temporal_events_clinical_en_2.5.5_2.4_1597774124917.zip 'Download')                                   |
re_clinical_en_2.5.5_2.4_1596928426753.zip 'Download')                                   |
