...
| `DeIdentificatoinModel`       | `deidentify_large`                              | `2.5.0` | [:mag:](# 'Extracts: Contact, Location, Name, Profession.')                                                                                                                                                                                                          | [:clipboard:](https://portal.dbmi.hms.harvard.edu/projects/n2c2-2014/ 'Trained on 10.000 Contact, Location, Name and Profession random replacements')                                                      | [:floppy_disk:](https://s3.console.aws.amazon.com/s3/object/auxdata.johnsnowlabs.com/clinical/models/deidentify_large_en_2.5.0_2.4_1590091237648.zip 'Download')                              |
...
| `NerDLModel`                  | `assertion_dl_large`                            | `2.5.0` |                                                                                                                                                                                                                                                                      | [:clipboard:](# 'Trained on i2b2')                                                                                                                                                                         | [:floppy_disk:](https://s3.console.aws.amazon.com/s3/object/auxdata.johnsnowlabs.com/clinical/models/assertion_dl_large_en_2.5.0_2.4_1590022282256.zip 'Download')                            |
...
| `NerDLModel`                  | `ner_events_clinical`                           | `2.5.0` | [:mag:](# 'Extracts: Problem, Test, Treatment, Occurence, Clinical_Dept, Date, Evidential, Duration, Frequency, Admission, Discharge, Time')                                                                                                                         | [:clipboard:](https://portal.dbmi.hms.harvard.edu/projects/n2c2-nlp/ 'Trained on i2b2 events data')                                                                                                        | [:floppy_disk:](https://s3.console.aws.amazon.com/s3/object/auxdata.johnsnowlabs.com/clinical/models/ner_events_clinical_en_2.5.0_2.4_1590021303624.zip 'Download')                           |
...
| `NerDLModel`                  | `ner_large_clinical`                            | `2.5.0` | [:mag:](# 'Extracts: Problem, Test, Treatment')                                                                                                                                                                                                                      | [:clipboard:](https://portal.dbmi.hms.harvard.edu/projects/n2c2-nlp/ 'Trained on i2b2 augmented data')                                                                                                     | [:floppy_disk:](https://s3.console.aws.amazon.com/s3/object/auxdata.johnsnowlabs.com/clinical/models/ner_large_clinical_en_2.5.0_2.4_1590021302624.zip 'Download')                            |
