...
| `ChunkEntityResolverModel`    | `chunkresolve_icdo_clinical`        | `2.4.2` | Trained on ICD-O Histology Behaviour dataset                                                                               | [:floppy_disk:](https://s3.console.aws.amazon.com/s3/object/auxdata.johnsnowlabs.com/clinical/models/chunkresolve_icdo_clinical_en_2.4.2_2.4_1583085316343.zip 'Download')        |
