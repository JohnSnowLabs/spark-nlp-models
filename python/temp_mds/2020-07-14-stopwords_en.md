...
{:.btn-box}
<button class="button button-orange" disabled>Live Demo</button><br/>[Open in Colab](https://github.com/JohnSnowLabs/spark-nlp-workshop/blob/b2eb08610dd49d5b15077cc499a94b4ec1e8b861/jupyter/annotation/english/stop-words/StopWordsCleaner.ipynb){:.button.button-orange.button-orange-trans.co.button-icon}<br/>[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/stopwords_en_2.5.3_2.4_1594742439135.zip){:.button.button-orange.button-orange-trans.arr.button-icon}<br/>
...
```python
model = StopWordsCleaner.pretrained("stopwords","en","public/models")\
	.setInputCols("token")\
