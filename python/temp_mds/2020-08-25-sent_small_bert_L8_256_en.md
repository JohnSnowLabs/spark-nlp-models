...
{:.btn-box}
<button class="button button-orange" disabled>Live Demo</button><br/><button class="button button-orange" disabled>Open in Colab</button><br/>[Download](https://s3.amazonaws.com/auxdata.johnsnowlabs.com/public/models/sent_small_bert_L8_256_en_2.6.0_2.4_1598350433990.zip){:.button.button-orange.button-orange-trans.arr.button-icon}<br/>
...
```python
model = BertSentenceEmbeddings.pretrained("sent_small_bert_L8_256","en","public/models")\
